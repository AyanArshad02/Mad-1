...
class Service(db.Model):
    ...
    professional_id = db.Column(db.Integer, db.ForeignKey('service_professional.id'), nullable=True) #new
    professional = db.relationship('ServiceProfessional', backref='services', lazy=True) #new
...
class ServiceRequest(db.Model):
    ...
    service_status = db.Column(db.String(50), default="requested", nullable=False)
